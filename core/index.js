...
async function addPassengers(req){
    return promise = new Promise((resolve,reject)=>{
        ...
        let sql = `INSERT INTO passenger (user_ID,title,first_name,last_name,passport_no,age) VALUES ('${user_ID}','${title}','${first_name}','${last_name}','${passport_no}','${age}')`;
        db.query(sql,(err,result)=>{
            if(err){
...
module.exports = { registerUser, loginUser, searchFlight, addPassengers};