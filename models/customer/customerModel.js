...
// exports.seatBook = async(req) => {
//     let seat_number = req.body.seat_number;
//     let passenger_ID = req.body.passenger_ID;
//     let passport_no = req.body.passport_no;
//     console.log('Make sure the passenger IDs you enter exactly match its passport.');
//     let getPassport = `SELECT passport_no FROM passenger WHERE passenger_ID='${passenger_ID}'`;

//     function checkPassport(){
//         db.query(getPassport,(err,result)=>{
//             if(err){
//                 console.log('err: ',err);
//                 console.log('check your passenger id and passport number again...');
//                 return false;
//             }
//             else{
//                 let originalPassport = result[0]['passport_no'];
//                 console.log(originalPassport);
//                 if(originalPassport===passport_no){
//                     console.log('passports matched');
//                     return true;
//                 }
//                 else{
//                     console.log('passports are not matched');
//                     return false;
//                 }
//             }
//         });
...
//     let matched = checkPassport();
//     console.log(matched);
//     if(matched){
//         console.log('inside final fn');
//     }
    
//     let sql = `UPDATE seat SET status=1 WHERE seat_number='${seat_number}'`;
//     // let result = await model.seatBook(req);
//     // return result;
// }
